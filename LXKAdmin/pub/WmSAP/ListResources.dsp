...
<HTML>
    ...
    <BODY onLoad="setNavigation('ListResources.dsp','%value helpsys%', 'foo');%ifvar lt8%%else%showHideFilterCriteria('searchConnectionName');%endif%">    
    %ifvar lt8%%else%<form name="form" action="ListResources.dsp" method="POST">%endif%    
        <table width="100%">
        <tr>
           <td class="menusection-Adapters" colspan=9>Adapters &gt; %value displayName% &gt; Connections</td>
        </tr>
        ...
        %ifvar connDataNode -notempty%
            ...
            %endloop%
        %else%
            <tr><td class="message" colspan=9>No connections found</td></tr>
        %endif%
