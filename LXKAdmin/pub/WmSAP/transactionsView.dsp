  ...
  <body onLoad="setNavigation('/WmSAP/transactions.dsp?adapterTypeName=WmSAP', '/WmSAP/doc/OnlineHelp/wwhelp/wwhimpl/js/html/wwhelp.htm?context=Help&topic=IS_TS_TID', 'foo');">
	...
	<td>
	  <form method="get" action="transactions.dsp">
	    ...
	    %invoke LXKAdmin.sap.Transaction:getMessageBody%
	    %invoke LXKAdmin.sap.Transaction:getPipeline%
		...
		<tr>
		  ...
		  %else%
		   ...
		   <td class="oddrowdata-l">
		    <a href="/invoke/LXKAdmin.sap.Transaction:viewTransactionAs?type=xml&amp;$tid=%value $tid%&amp;receiver=%value -urlencode receiver%&amp;msgType=%value -urlencode msgType%">message body as XML</a><br />
		   %ifvar represents equals('idoc')%
		     <a href="/invoke/LXKAdmin.sap.Transaction:viewTransactionAs?type=html&amp;$tid=%value $tid%&amp;receiver=%value -urlencode receiver%&amp;msgType=%value -urlencode msgType%&amp;$sortKey=%value $sortKey%&amp;$dir=%value $dir%">message body as HTML</a><br />
		   %endif%
		     <a href="/invoke/LXKAdmin.sap.Transaction:viewTransactionAs?type=values&amp;$tid=%value $tid%&amp;receiver=%value -urlencode receiver%&amp;msgType=%value -urlencode msgType%">complete pipeline</a>
		   </td>
		  %endif%
		</tr>
		<tr><td class="space" colspan="2">&nbsp;</td></tr>
		...
		<tr>
		  ...
		  <td class="oddrowdata-l">%value none message%</td>
		</tr>
		<!-- %endloop% -->
	      </tbody>
	      <tbody>
