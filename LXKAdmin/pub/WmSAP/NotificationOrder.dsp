    ...
    <body>
        ...
        <table width=100%>
            ...
            %ifvar readOnly equals('true')%
                <td class="menusection-Adapters" colspan=2>Adapters &gt; %value adapterDisplayName% &gt; View Listener &gt; View Notification Order</td>
            %else%
                <td class="menusection-Adapters" colspan=2>Adapters &gt; %value adapterDisplayName% &gt; Edit Listener &gt; Edit Notification Order</td>
            %endif%
            </tr>
            ...
            <tr>
                <td colspan=2>
                    <ul>
                        <li>
                        %ifvar readOnly equals('true')%
                            <a href="ListenerDetails.dsp?%ifvar lt8%lt8=true&amp;%endif%readOnly=%value readOnly%&adapterTypeName=%value -urlencode adapterTypeName%&listenerNodeName=%value listenerNodeName%&dspName=.LISTRESOURCES">
            ...
            <tr>
                <td><img src="/WmART/images/blank.gif" height="10" width="10"></td>
                <td>
                        ...
                        <table width="100%" class="tableForm" cellpadding=2 cellspacing=2>
                            ...
                            <tr>
                                <td class="action" colspan=2>
                                    %ifvar readOnly equals('true')%
                                    %else%
                                        %ifvar lt8%<INPUT NAME="lt8"  VALUE="true"  TYPE=hidden>%endif%
                                        <INPUT NAME="adapterDisplayName"  VALUE="%value adapterDisplayName%"  TYPE=hidden>
