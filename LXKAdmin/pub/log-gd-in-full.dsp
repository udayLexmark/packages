<HTML>
  ...
  <BODY onLoad="setNavigation('log-gd-in-full.dsp', '/WmRoot/doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Logs_GDInboundLogScrn');">
      ...
      %endif%
          <TABLE width=100%>
            ...
            <TR>
              <TD colspan="2">
                <UL>
                  <LI><A HREF="log-gd-out-full.dsp">View Guaranteed Delivery Outbound Log</A></LI>
                </UL>
              </TD>
            </TR>
            <TR>
