...
%switch action%
%case 'svcPull'%
  %invoke LXKAdmin.server.query:distributeViaSvcPull%
  <TR><td id="message" colspan=5>%value none message%</td></TR>
  %endinvoke%
%case 'ftpPull'%
  %invoke LXKAdmin.server.query:pullPackageViaFtp%
  <TR><td id="message" colspan=5>%value none message%</td></TR>
  %endinvoke%
%endswitch%
%endif%

%invoke LXKAdmin.server.query:queryPublisherForPackages%
