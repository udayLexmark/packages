...
%invoke LXKAdmin.server.query.adminui:mainMenu%
...
%loop sections%
		...
		%else%
			%ifvar value text equals('Server')%
				<TR manualhide="false" onClick="toggle(this, '%value text%_subMenu', '%value text%_twistie');" OnMouseOver="this.className='cursor';"><TD CLASS="menusection-%value name%">
				   <img id='%value text%_twistie' src="images/expanded.gif">&nbsp;%value text%
				</TD></TR>
			%else%
				<TR manualhide="true" onClick="toggle(this, '%value text%_subMenu', '%value text%_twistie');" OnMouseOver="this.className='cursor';"><TD CLASS="menusection-%value name%">
