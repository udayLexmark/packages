 ...
 <TR>
	      <TD colspan=2>
	        <TABLE class="tableView">
                  <TR>
                  %ifvar logdate%
                    <TD colspan=10 class="heading">Security Log Entries as of %value logdate%</TD>
                  %else%	
                  ...
                  <TR>
                    ...
                    <TD class="oddcol">Client Id</TD>
                    <TD class="oddcol">User Id</TD>
                    <TD class="oddcol">Security Event Type</TD>
                  ...
                  <TR>
                     ...
                     <SCRIPT>writeTDnowrap("row-l");</SCRIPT>%value MESSAGE%</TD>
                     <SCRIPT>writeTDnowrap("row-l");</SCRIPT>%value ServerID%</TD>
                     <SCRIPT>writeTDnowrap("row-l");</SCRIPT>%value ClientID%</TD>
                     <SCRIPT>writeTDnowrap("row-l");</SCRIPT>%value UserID%</TD>
                     <SCRIPT>writeTDnowrap("row-l");</SCRIPT>%value TYPE%</TD>
