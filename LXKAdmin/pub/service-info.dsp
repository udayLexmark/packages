<html>
	...
	%invoke LXKAdmin.server.query:serviceInfo%
   <table width="100%">
        <tr>
     ...
     <tr>
         ...
         <td width="50%" valign=top>
            <table class="tableView" width="100%">
               ...
               <tr>
               		<td width="33%" class="oddrow">Namespace Name</td>
		          ...
		          <tr>
								<td class="evenrow">Local Name</td>
								<td class="evenrowdata-l">
         ...
         <tr>
            <td class="evenrow">Output Template</td>
            <td class="evenrowdata-l">%value template empty=&lt;None&gt;%</td>
         </tr>
         <tr>
            <td class="oddrow">Template Type</td>
