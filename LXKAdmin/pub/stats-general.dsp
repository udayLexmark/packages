...
<META HTTP-EQUIV="Expires" CONTENT="-1">
  ...
  <SCRIPT SRC="webMethods.js.txt"></SCRIPT>
   ...
   <BODY onLoad="setNavigation('stats-general.dsp', '/WmRoot/doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Server_SrvrStatsScrn');">
	  ...
	  %invoke LXKAdmin.server.query:getReadOnlyConfigFiles%
	  ...
	  %invoke LXKAdmin.server.query:getClusterError%
	  ...
	  %invoke LXKAdmin.server.query:getStats%
         <TR>
            <TD width="10">
            ...
            <TD valign="top">
               <TABLE class="tableView" width="100%">
                  ...
                  <TR>
                     ...
                     <TD nowrap class="evenrowdata">%value svrT%</TD>
                     <TD nowrap class="evenrowdata">%value svrTMax%</TD>
                     <TD nowrap class="evenrowdata">-</TD>
                  </TR>
                  <TR>
