        ...
        <input type="hidden" name="passwordChange" value="false">
            ...
            <table width=100%>
                ...
                <tr>
                    <td colspan=2>
                        <ul>
                            <li><a href="ListListeners.dsp?%ifvar lt8%lt8=true&amp;%endif%adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&dspName=.LISTRESOURCES">
