                    ...
                    %loop listenerTypes%
                        <tr>
                            <script>writeTD('rowdata-l');</script>
                                <a href="SetListenerProperties.dsp?%ifvar ../lt8%lt8=true&amp;%endif%adapterTypeName=%value -urlencode adapterTypeName%&listenerTypeName=%value -urlencode listenerTypeName%">%value listenerDisplay%</a>
                            </td>
