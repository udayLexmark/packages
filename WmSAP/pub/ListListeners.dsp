                    ...
                    <ul>
                        <li>
                            %invoke wm.art.admin.connection:listResources%
                                %ifvar connDataNode%
                                    <a href="ListAdapterListenerTypes.dsp?%ifvar lt8%lt8=true&amp;%endif%adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&dspName=.LISTLISTENERTYPES">
                        ...
                        <li>
				            <a href="ListListeners.dsp?%ifvar lt8%lt8=true&amp;%endif%adapterTypeName=%value -urlencode adapterTypeName%&action=suspendAllEnabled">
            				    Suspend all enabled</a>
                         </li>
                         <li>
                             <a href="ListListeners.dsp?%ifvar lt8%lt8=true&amp;%endif%adapterTypeName=%value -urlencode adapterTypeName%&action=enableAllSuspended">
                        ...
                        <tr>
                            ...
                            <script>writeTD('rowdata');</script>
                                ...
                                %case 'enablePending'%
                                    <img src="/WmART/icons/disabled_edit.gif" alt="Edit" border=0>
                                %case 'suspended'%
                                    <a href="ListenerDetails.dsp?%ifvar ../lt8%lt8=true&amp;%endif%readOnly=some&adapterTypeName=%value -urlencode ../adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&listenerNodeName=%value -urlencode listenerNodeName%&dspName=.LISTLISTENERDETAILS">
                                        <img src="/WmART/icons/config_edit.gif" alt="Edit" border=0></a>
                                %case 'suspendPending'%
                                    <a href="ListenerDetails.dsp?%ifvar ../lt8%lt8=true&amp;%endif%readOnly=some&adapterTypeName=%value -urlencode ../adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&listenerNodeName=%value -urlencode listenerNodeName%&dspName=.LISTLISTENERDETAILS">
                                        <img src="/WmART/icons/config_edit.gif" alt="Edit" border=0></a>
                                %case%
                                    <a href="ListenerDetails.dsp?%ifvar ../lt8%lt8=true&amp;%endif%readOnly=false&adapterTypeName=%value -urlencode ../adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&listenerNodeName=%value -urlencode listenerNodeName%&dspName=.LISTLISTENERDETAILS">
                                        <img src="/WmART/icons/config_edit.gif" alt="Edit" border=0></a>
                                %endswitch%
                            </td>
                            ...
                            <script>writeTD('rowdata');</script>
                              ...
                              %else%
                                <a href="CopyListener.dsp?%ifvar ../lt8%lt8=true&amp;%endif%readOnly=false&adapterTypeName=%value -urlencode ../adapterTypeName%&listenerNodeName=%value -urlencode listenerNodeName%&dspName=.LISTLISTENERDETAILS">
                            ...
                            <script>writeTD('rowdata'); swapRows();</script>
                                %ifvar listenerEnabled equals('disabled')%
                                  ...
                                  %else%
                                    <a href="ListListeners.dsp?%ifvar ../lt8%lt8=true&amp;%endif%action=deleteListener&%&adapterTypeName=%value -urlencode ../adapterTypeName%&listenerNodeName=%value -urlencode listenerNodeName%&dspName=.LISTLISTENERDETAILS"
