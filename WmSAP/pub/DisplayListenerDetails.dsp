%ifvar listenerData%
	...
	<td colspan=2>Listener Properties</td></tr>
	            ...
	            <tr>
	                ...
	                %else%
	                    %ifvar resourceDomain -notEmpty%
				            <script>writeTD('rowdata-l');swapRows();</script>
	                        <select name=".CPROP.%value systemName%"  %ifvar systemName equals('sncMode')%onchange="handleSNCChange1(this.form);"%endif%>
	                            %loop resourceDomain%
