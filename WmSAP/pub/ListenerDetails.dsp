            ...
            <table width="100%">
                ...
                <tr>
                    <td colspan="2">
                        <ul>
                            <li>
                                <a href="ListListeners.dsp?%ifvar lt8%lt8=true&amp;%endif%adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&dspName=.LISTRESOURCES">
                                    Return to %value displayName% Listeners
                                </a>
                            </li>
                            <li>
                                %ifvar readOnly equals('true')%
                                    <a href="NotificationOrder.dsp?%ifvar lt8%lt8=true&amp;%endif%readOnly=true&adapterDisplayName=%value displayName%&adapterTypeName=%value -urlencode adapterTypeName%&listenerNodeName=%value listenerNodeName%">
                                        View Notification Order
                                    </a>
                                %else%       
                                    <a href="NotificationOrder.dsp?%ifvar lt8%lt8=true&amp;%endif%readOnly=false&adapterDisplayName=%value displayName%&adapterTypeName=%value -urlencode adapterTypeName%&listenerNodeName=%value listenerNodeName%">
