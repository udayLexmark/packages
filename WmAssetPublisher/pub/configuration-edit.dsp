        ...
        <table width="100%">
            ...
            <tr>
                <td colspan="2">
                    <ul>
						<script>
						createForm("htmlform_configuration_return", "/WmAssetPublisher/configuration.dsp", "POST", "BODY");
						</script>
                        <li><script>getURL("/WmAssetPublisher/configuration.dsp", "javascript:document.htmlform_configuration_return.submit();", "Return to Configuration");</script>
						</li>
                    </ul>
                </td>
            </tr>
                    ...
                    <table class="tableView" width="50%">
                        %invoke wm.server.metadata.Admin:getConfiguration%
	                        ...
	                        <script language="JavaScript">function confirmEdit() { 
                                ...
                                <tr>
                                    <script>writeTDWidth("row-l", "20%")</script><label for="IS_IDENTIFIER">IS Identifier</label></td>
                                    <script>writeTD("rowdata-l")</script>
                                        <input type="text" 
                                               name="IS_IDENTIFIER" id="IS_IDENTIFIER" 
                                ...
                                <tr>
                                    <script>writeTD("row-l")</script><label for="MDL_URL">CentraSite URL</label></td>
                                    <script>writeTD("rowdata-l")</script>
                                    <input type="text" name="MDL_URL" id="MDL_URL" value="%value MDL_URL%" style="width:100%" onChange="checkLibrary()"/>
                                    (For example: http://localhost:53307/CentraSite/CentraSite)
                                    <script>swapRows();</script>
                                </tr>
                        
                                <tr>
                                    <script>writeTD("row-l")</script><label for="MDL_USERNAME">User Name</label></td>
                                    <script>writeTD("rowdata-l")</script>
                                    <input type="text" name="MDL_USERNAME" id="MDL_USERNAME" value="%value MDL_USERNAME%" style="width:100%"/>
                                    <script>swapRows();</script>
                                </tr>
                        
                                <tr>
                                    <script>writeTD("row-l")</script><label for="MDL_PASSWORD">Password</label></td>
                                    <script>writeTD("rowdata-l")</script>
                                    <input type="password" autocomplete="off" name="MDL_PASSWORD" id="MDL_PASSWORD" value=%ifvar MDL_PASSWORD -notempty%"********"%else%""%endif% style="width:100%"/>
                                    <script>swapRows();</script>
                                </tr>
