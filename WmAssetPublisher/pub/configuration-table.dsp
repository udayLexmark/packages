<table width="100%">
    ...
    <tr>
        <td colspan="2">
            <ul>
				<script>
				createForm("htmlform_configuration_edit", "/WmAssetPublisher/configuration-edit.dsp", "POST", "BODY");
				</script>
                <li>
				<script>getURL("/WmAssetPublisher/configuration-edit.dsp", "javascript:document.htmlform_configuration_edit.submit();", "Edit Configuration");</script>
				</li>
            </ul>
        </td>
    </tr>
