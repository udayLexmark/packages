...
<body style="border-spacing: 0; border-width:0">
	...
	<style type="text/css" rel="stylesheet">
		...
		.hovertan {background-color: #8bcfed}		
		.hovertan tr:hover { color: #333; background-color: #8bcfed;opacity:.70;filter: alpha(opacity=50); -moz-opacity: 0.5;border:1px solid black;  }		
	</style>
