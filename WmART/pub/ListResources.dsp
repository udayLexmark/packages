...
<table class="tableView"width="100%">
            ...
            %loop connDataNode%
                ...
                <tr>
                    ...
                    %ifvar connectionState equals('disabled')%
                        <script>writeTD('rowdata');</script>
                            <a href="../WmART/ConnNodeDetails.dsp?readOnly=false&connectionAlias=%value -urlencode connectionAlias%&adapterTypeName=%value -urlencode ../adapterTypeName%&searchConnectionName=%value -urlencode ../searchConnectionName%&adapterPackageName=%value -urlencode ../adapterPackageName%">
                    ...
                    <script>writeTD('rowdata');</script>
                        ...
                        <a href="../WmART/CopyConnection.dsp?readOnly=false&connectionAlias=%value -urlencode connectionAlias%&adapterTypeName=%value -urlencode ../adapterTypeName%&searchConnectionName=%value -urlencode ../searchConnectionName%&adapterPackageName=%value -urlencode ../adapterPackageName%">
		...
		<div class="oddrowdata" id="goContainer" name="goContainer" style="display:none;padding-top=2mm;">
			...
			%else%		
        		<a href="../WmART/ListResources.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchConnectionName=%value -urlencode searchConnectionName%&prev=true&dspName=.LISTRESOURCES">&laquo; Previous</a>&nbsp;<label class="evenrowdata-l">Page (1-
