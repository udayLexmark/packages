        ...
        <input type="hidden" name="passwordChange" value="false">
            ...
            <table width=100%>
                ...
                <tr>
                    <td  colspan=2>
                        <ul>
                            <li><a href="ListListeners.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchListenerName=%value -urlencode searchListenerName%&dspName=.LISTRESOURCES">
		...
		%comment%-- New for Elbe Release --%endcomment%
                ...
                %onerror%
                    %ifvar localizedMessage%
                        ...
                        <tr><td class="message" colspan="2">Error encountered <%value error%> %value localizedMessage%</td></tr>
                    %else%
                        %ifvar error%
                            <tr><td class="message" colspan="2">Error encountered <%value error%> %value errorMessage%</td></tr>
                        %endif%
                    %endif%
                %endinvoke%
				</tbody>
