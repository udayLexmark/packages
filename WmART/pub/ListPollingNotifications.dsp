...
<table class="tableView" width="100%">
			  ...
			  <SCRIPT>
				function callback(val,nodeID){
					...
					<!--  RUN AS USER SUB CHANGES START-->
						...
						<a class="submodal" href="../WmART/subUserLookup.dsp?notificationNodeName=%value notificationNodeName%">
	...
	<div class="oddrowdata" id="goContainer" name="goContainer" style="display:none;padding-top=2mm;">
		...
		%else%		
        		<a href="../WmART/ListPollingNotifications.dsp?adapterTypeName=%value -urlencode adapterTypeName%&searchNotificationName=%value -urlencode searchNotificationName%&prev=true&dspName=.LISTPOLLINGNOTIFICATIONDETAILS">&laquo; Previous</a>&nbsp;<label class="evenrowdata-l">Page (1-
