%ifvar listenerData%
    ...
    <tr ><td class="subheading" colspan=2>Listener Properties</td></tr>
    ...
    %else%
	    ...
	    %endif%
	%endif%
    <tr ><td class="subheading" colspan=2 >Last Error</td></tr>
...
%else%
    ...
    <tr><td colspan=4>Listener properties not found</td></tr>
%endif%
