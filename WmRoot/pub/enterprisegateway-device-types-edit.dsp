<html>
    <head>
      ...
      <body onLoad="setNavigation('enterprisegateway-devicetypes-add.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_EnterpriseGatewayRules_MobileApplicationProtectionOptions_EditDeviceTypesScrn');">
                                ...
                                <table class="tableView" width="100%">
                                   ...
                                   <tr>
                                        <td class="oddrow" width="20%">
											<label for="mobileAppDeviceTypes">Device Types</label>
                                        </td>
                                        <td class="oddrow-l">
