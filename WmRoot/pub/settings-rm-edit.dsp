...
<head>
  ...
  <script language="JavaScript">
    ...
    <body onLoad="setNavigation('settings-rm-edit.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_ReliableMessagingPropertiesScrn');">
        ...
        <tr>
            <td colspan="2">
                <ul class="listitems">
                    ...
                    <li class="listitem"><script>getURL("settings-wsendpoints.dsp", "javascript:document.htmlform_settings_wsendpoints.submit();", "Return to Web Service Endpoints");</script>
					
					</li>
                    <li class="listitem"><script>getURL("settings-rm.dsp", "javascript:document.htmlform_settings_rm.submit();", "Return to Reliable Messaging");</script>
                ...
                <tr>
                    <td>    
                        <table class="tableView" width="100%">
                            ...
                            <tr>
                                <td class="evenrow" width="40%"><label for="retransmissionInterval">Retransmission Interval</label></td>    
                            ...
                            <tr>
                                <td class="oddrow"><label for="acknowledgementInterval">Acknowledgement Interval</label></td>    
                                <td class="oddrow-l">
                            ...
                            <tr>
                                <td class="evenrow"><label for="exponentialBackoff">Exponential Backoff</label></td>    
                                <td class="evenrow-l">
                            ...
                            <tr>
                                <td class="oddrow"><label for="inactivityTimeout">Inactivity Timeout Interval</label></td> 
                                <td class="oddrow-l">
                            ...
                            <tr>
                                <td class="evenrow"><label for="sequenceRemovalTimeout">Sequence Removal Timeout Interval</label></td>  
                                <td class="evenrow-l">
                                    <table cellpadding="0px" cellspacing="0px" width="100%">
                                        <tr>
                                            <td width="50%">
                            ...
                            <tr>
                                <td class="oddrow"><label for="invokeInOrder">In-Order Delivery Assurance</label></td> 
                                <td class="oddrow-l">
                            ...
                            <tr>
                                <td class="evenrow"><label for="maximumRetransmissionCount">Maximum Retransmission Count</label></td>   
                                <td class="evenrow-l">
                            ...
                            <tr>
                                <td class="oddrow"><label for="storageType">Storage Type</label></td>    
                                <td class="oddrow-l">
                            ...
                            <tr>
                                <td class="evenrow"><label for="houseKeepingInterval">Housekeeping Interval</label></td> 
                                <td class="evenrow-l">
