  ...
  <SCRIPT LANGUAGE="JavaScript">
    ...
    function loadDocument() {
	    //alert("%value certfileType encode(javascript)%");
          ...
          setNavigation('settings-wm-des-edit.dsp',  'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_Messaging_webMMsgingSettings_ConnectionAlias_EditUMScrn');
    ...
    <TR>
      <TD colspan="2">
        <ul class="listitems">
          <li class="listitem">
		  <script>
		  createForm("htmlform_settings_wm_des_detail", "settings-wm-des-detail.dsp", "POST", "BODY");
		  setFormProperty("htmlform_settings_wm_des_detail", "aliasName", "%value aliasName encode(url)%");
		  </script>
		  <script>getURL("settings-wm-des-detail.dsp?aliasName=%value aliasName encode(url)%", "javascript:document.htmlform_settings_wm_des_detail.submit();", "Return to Digital Event Services Connection Alias");</script>
            ...
            <TD class="evenrowdata-l">
              %ifvar isISClustered equals(true)%
                %ifvar isClientPrefixShared equals(true)%
                              <INPUT TYPE="checkbox" disabled="true" NAME="isClientPrefixShared" id="isClientPrefixShared" checked="true">
                            %else%
                              <INPUT TYPE="checkbox" disabled="true" NAME="isClientPrefixShared" id="isClientPrefixShared" >
                          %endif%
                        %else%
                            %ifvar isClientPrefixShared equals(true)%
                              <INPUT TYPE="checkbox" NAME="isClientPrefixShared" checked="true" id="isClientPrefixShared" >
                            %else%
                              <INPUT TYPE="checkbox" NAME="isClientPrefixShared" id="isClientPrefixShared" >
                          %endif%
                        %endif%
                      </TD>
          </TR>
