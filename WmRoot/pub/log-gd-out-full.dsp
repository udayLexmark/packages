<HTML>
  ...
  <BODY onLoad="setNavigation('log-gd-in-full.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Logs_GDOutboundLogScrn');">
          ...
          <TABLE width=100%>
            ...
            <tr>
              <td colspan="2">
				...
				<script>
						    createForm("htmlform_http_log_gd_in_full", "log-gd-in-full.dsp", "POST", "BODY");
                </script>
				
                  <li class="listitem">
				  <script>getURL("log-gd-in-full.dsp","javascript:document.htmlform_http_log_gd_in_full.submit();","View Guaranteed Delivery Inbound Log");</script>
				  </li>
                </ul>
              </td>
            </tr>
