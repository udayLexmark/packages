...
<body style="border-spacing: 0; border-width:0">
    ...
    <th class="title" align=left scope="col" style="width:190px">Role/Group Name</th>
    <td class="title" align=left scope="col" style="width:45px">Type</td></tr>
...
//      window.location='subGroupLookup.dsp?startFrom='+startFrom;
  ...
  function queryUsers(){
    ...
    if(is_csrf_guard_enabled && needToInsertToken) {
		createForm("htmlForm_subGroupLookup", "subGroupLookup.dsp", "POST", "BODY");
		setFormProperty("htmlForm_subGroupLookup", "prov", prov);
		setFormProperty("htmlForm_subGroupLookup", "name", encodeURIComponent(query.value));
        setFormProperty("htmlForm_subGroupLookup", _csrfTokenNm_, _csrfTokenVal_);
		document.htmlForm_subGroupLookup.submit();
    } else {
