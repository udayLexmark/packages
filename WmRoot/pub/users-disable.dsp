<html>
  ...
  <BODY class="main" onLoad="setNavigation('users.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_EnableDisableUsersScrn');">
    <table width=100% >
...
<label for="enabledUsers">              Enabled Users</label><br>
...
<label for="disabledUsers">              Disabled Users</label><br>
