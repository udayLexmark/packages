...
<META HTTP-EQUIV="Expires" CONTENT="-1">
  ...
  <BODY onLoad="setNavigation('security-certificates.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_ConfigClientCertifScrn');">
        ...
        <TR>
          <TD colspan="2">
            <ul class="listitems">
              ...
              <li><script>getURL("security-certificates.dsp","javascript:document.htmlform_security_certificates.submit();","Return to Certificates");</script></li>
            </UL>
          </TD>
        </TR>
        <TR>
          <TD>
            <TABLE class="tableView" width=100%>
              ...
              <TR>
                <TD class="oddrow"><label for="cert">Certificate Path</label></TD>
                <TD class="oddrowdata-l">
                  <INPUT id="cert" type="text" name="certFilePath" style="width:100%">
                </td>
              </TR>
              <TR> 
			<TD class="evenrow">Example Paths</td> 
              ...
              <TR>
				...
				<input id="user" name="certificateUser" size=12 value="%value name encode(htmlattr)%"></input>
              ...
              <TR>
                <TD class="evenrow"><label for="usage1">Usage</label></TD>
                <TD class="evenrowdata-l">
					<SELECT id="usage1" NAME="certificateUsage" style="width:50%"> 
            ...
            <TABLE class="tableView" width=100%>
              <TR>
                ...
                <TR>
                  <TH scope="col" CLASS="oddcol-l">Subject CN</TH>
                  <TH scope="col" CLASS="oddcol">Issuer CN</TH>
                  <TH scope="col" CLASS="oddcol">Serial Number</TH>
                  <TH scope="col" CLASS="oddcol">User</TH>
                  <TH scope="col" CLASS="oddcol">Usage</TH>
                ...
                <TR>
                  ...
                  <script>writeTD("rowdata");</script>
                    <A class="imagelink" href="javascript:document.certificates.submit();"
                       ...
                       ><IMG class="position" border="0" alt="'%value certificateInfo/subjectCN%' Certificate" src="icons/delete.png"></A>
                  </TR>
