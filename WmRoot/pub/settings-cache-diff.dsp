...
<head>
  ...
  <body onLoad="setNavigation('settings-cache-diff.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_Cache_Add');">
  <table width="100%">
        ...
        <tr>
            <td colspan="2">
                <ul class="listitems">
					<script>
					createForm("htmlform_settings_cache_addedit", "settings-cache-addedit.dsp", "POST", "BODY");
					setFormProperty("htmlform_settings_cache_addedit", "cacheManagerName", "%value cacheManagerName%");
					setFormProperty("htmlform_settings_cache_addedit", "cacheName", "%value cacheName%");
					setFormProperty("htmlform_settings_cache_addedit", "operation", "edit");
					</script>
                    <li class="listitem">
					<script>getURL("settings-cache-addedit.dsp?cacheManagerName=%value cacheManagerName encode(url)%&cacheName=%value cacheName encode(url)%&operation=edit","javascript:document.htmlform_settings_cache_addedit.submit();","Return to&nbsp;%value cacheName encode(html)%")</script></li>
                </ul>
            </td>
        </tr>
        <tr>
                    ...
                    <tr>
                        <td valign="top" width="50%">   
                            <table class="tableView" width="99%">
                                ...
                                <tr>
                                    <TH class="oddcol" scope="col" width="50%">Name</TH>
                                    <TH class="oddcol" scope="col" width="25%">Configuration On Disk</TH>
                                    <TH class="oddcol" scope="col" width="25%">Configuration In Effect</TH>
                                </tr>
                                ...
                                <tr>
                                    <td class="oddcol" scope="col" width="50%">Name</td>
                                    <td class="oddcol" scope="col" width="25%">Configuration On Disk</td>
                                    <td class="oddcol" scope="col" width="25%">Configuration In Effect</td>
                                </tr>
                                <script>swapRows();</script>    
