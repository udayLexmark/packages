...
<META HTTP-EQUIV="Expires" CONTENT="-1">
  ...
  <BODY onLoad="setNavigation('settings-alias.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_URL_Alias_Edit');">
  %else%
  <BODY onLoad="setNavigation('settings-alias.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_URL_Alias_Create');">
  %endif%
    <TABLE width="100%">
      ...
      <TR>
        <TD colspan="2">
          <ul class="listitems">
		  <script>
			createForm("htmlform_settings_alias", "settings-alias.dsp", "POST", "BODY");
			</script>
            <li class="listitem"><script>getURL("settings-alias.dsp", "javascript:document.htmlform_settings_alias.submit();", "Return to URL Aliases");</script>
			</li>
          </UL>
        </TD>
      </TR>
          ...
          <TR>
            ...
            <TD class="oddrow-l">
                %ifvar alias equals('<EMPTY>')%
                    <INPUT NAME="alias" id="alias" size=100 VALUE="&lt;EMPTY&gt;" disabled=true> </TD>
                    <TD class="oddrow-l">
                        <INPUT TYPE="checkbox" checked name=isDefaultPath value=true onclick="enableDisableAlias();">
                %else%
                <INPUT NAME="alias" id="alias" size=100 VALUE="%value alias encode(htmlattr)%"> </TD>
                %ifvar isDev equals('false')%
                <TD class="oddrow-l">
                %else%
                <TD class="oddrow-l" disabled=true>
                %endif%
                            <INPUT TYPE="checkbox" id="isDefaultPath" name=isDefaultPath value=true onclick="enableDisableAlias();">
                        
              %endif%
             <label for="isDefaultPath">Use as empty path alias</label></TD>
          </TR>
%invoke wm.server.httpUrlAlias:getAlias%
          <TR>
            <TD class="evenrow"><label for="urlPath">URL Path</label></TD>
            %ifvar isDev equals('true')%
              <TD class="evenrowdata-l" colspan="2">%value urlPath encode(html)%</TD>
              <INPUT TYPE="hidden" id="urlPath" NAME="urlPath" VALUE="%value urlPath encode(htmlattr)%">
            %else%
            <TD class="evenrow-l" colspan="2">
              <INPUT NAME="urlPath" id="urlPath" size=100 VALUE="%value urlPath encode(htmlattr)%"> </TD>
            %endif%
          </TR>
          <TR>
            <TD class="oddrow"><label for="package">Package</label></TD>
 ...
 %ifvar isDev equals('false')% 
          ...
          <TR>
            <TD class="oddrow-l" colspan="3"><TABLE id=portMaps width="100%">
                <TR>
                   <TH scope="col" class="oddcol-l">Port Number</TH>
                   <TH scope="col" class="oddcol-l" colspan="2">URL Path</TH>
                   <TH scope="col" class="oddcol">Delete Mapping</TH>
                </TR>
                %ifvar portMap%
                %loop portMap%
                <TR id="%value port encode(url)%">
                   ...
                   <TD class='evenrowdata'>
                                   <a href="#"  onClick="return deletePortMapping('%value port%');">
                                        <IMG src="icons/IS_Delete.png" alt="Delete Mapping for Port Number %value port%" border="none">
                                   </a>
            ...
            <TR id="newMapColHeading">
                   <TH scope="col" class='oddcol-l'><label for="port">Port Number</label></TH>
                   <TH scope="col" class='oddcol-l' colspan="2"><label for="urlPATH">URL Path</label></TH>
                   <TH scope="col" class='oddcol'>Add Mapping</TH>
            </TR>
            <TR id="newMapData">
                <TD class='evenrow-l'>
                ...
                <TD class='evenrowdata-l' colspan="2">
                  <INPUT NAME="newPATH" size=100 VALUE="" id="urlPATH"> </TD>
              <TD class='evenrowdata'>
                <a href="#"  onClick="return addPortMapping();"> 
                                <IMG src="icons/IS_Add.png" alt="Add port mapping" border="none">
                              </a>
                </TD>
            </TR>
            </TABLE></TD>
