                ...
                <tr>
                    <td>    
                        <table class="tableView" width="100%">
                            ...
                            <tr>
                                <td class="evenrow" ><label for="hostName">Host Name or IP Address</label></td>
                                <td class="evenrow-l" >
                                    %ifvar operation equals('add')%
							...
							<tr>
								<td class="oddrow" width="30%"><label for="preferredKeyExchangeAlgorithmSel">Preferred Key Exchange Algorithms</label></td>
							...
							<tr>
								<td class="oddrow" width="30%"><label for="proxyAlias">Proxy Alias</label></td>
								<td class="oddrow-l" width="70%">
									%ifvar operation equals('add')%
                            ...
                            <tr>
                                <td class="evenrow" >%ifvar operation equals('add')% <label for="hostKeyLocation"> Host Key Location </label> %endif% %ifvar operation equals('edit')% <label for="fingerprint"> Host Key Fingerprint</label> %endif%    </td>
                                <td class="evenrow-l" >
                            ...
                            %ifvar operation equals('edit')%
                            <tr>
                                <td class="oddrow" ><label for="hostKeyLocation">Host Key Location</label></td>
                                <td class="oddrow-l" >
