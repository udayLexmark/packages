...
<SCRIPT LANGUAGE="JavaScript">
                  ...
                  %endif%
                                %ifvar mode equals('edit')%
                  					%invoke wm.server.security.keystore:getKeyStore%
                  						%scope keyStore%
                  							selectedKS = "%value keyStoreType encode(html)%";
                  						%endscope%
                  					%endinvoke%
                  				%endif%
    ...
    <style>
      .listbox  { width: 100%; }
            ...
            %ifvar mode equals('edit')%
                        %ifvar type equals('key')%
                            <BODY onLoad="setupKeystoreData();setNavigation('security-keystoremgt-keystore.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_EditKeystoreAliasScrn');">
                        %else%
                            <BODY onLoad="setupKeystoreData();setNavigation('security-keystoremgt-keystore.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_EditTruststoreAliasScrn');">         
                        %endif% 
            %else%
                %ifvar mode equals('view')%
                        %ifvar type equals('key')%
                            <BODY onLoad="setNavigation('security-keystoremgt-keystore.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_ViewKeystoreAliasScrn');">
                        %else%
                            <BODY onLoad="setNavigation('security-keystoremgt-keystore.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_ViewTruststoreAliasScrn');">
                        %endif%
                ...
                %else%
                        %ifvar type equals('key')%
                            %ifvar mode equals('edit_edit')%
                                <BODY onLoad="setupKeystoreData();setNavigation('security-keystoremgt-keystore.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_EditKeystoreAliasScrn');">
                            %else%
                                <BODY onLoad="setupKeystoreData();setNavigation('security-keystoremgt-keystore.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_CreateKeystoreAliasScrn');">
                            %endif%
                        %else%
                            <BODY onLoad="setupKeystoreData();setNavigation('security-keystoremgt-keystore.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_CreateTruststoreAliasScrn');">
                        %endif%
                %endif%
            %endif%
    ...
    <TABLE width="100%">
      ...
      <TR>
        <TD colspan=2>
          <ul class="listitems">
		    <script>
			createForm("htmlform_security_keystoremgt", "security-keystoremgt.dsp", "POST", "BODY");
			</script>
            <li>
			<script>getURL("security-keystoremgt.dsp","javascript:document.htmlform_security_keystoremgt.submit();","Return to Keystore");</script>
			</li>
            %ifvar mode equals('view')%
				<script>
				createForm("htmlform_security_keystoremgt_keystore", "security-keystoremgt-keystore.dsp", "POST", "BODY");
				setFormProperty("htmlform_security_keystoremgt_keystore", "mode", "edit");
				setFormProperty("htmlform_security_keystoremgt_keystore", "keyStoreName", "%value keyStoreName%");
				setFormProperty("htmlform_security_keystoremgt_keystore", "type", "%value type%");
				</script>
                <li>
				<script>getURL("security-keystoremgt-keystore.dsp?mode=edit&keyStoreName=%value keyStoreName encode(url)%&type=%value type encode(url)%","javascript:document.htmlform_security_keystoremgt_keystore.submit();","Edit %ifvar type equals('key')%Keystore Alias%else%Truststore Alias%endif%");</script>
                </LI>            
            %endif%
          </UL>
        </TD>
        ...
        %else%
            ...
            %ifvar mode matches('edit*')% <!-- Edit keystore/truststore alias block-->
                %ifvar mode equals('edit')% <!-- Edit keystore/truststore alias block-->
                        ...
                        %scope keyStore%
                        <TR>
				        	<TD class="oddrow"><label for="ksname">Alias</label></TD>
                            <TD class="oddrow-l">
				          	<B>%value keyStoreName encode(html)%</B>
				          	<INPUT id="ksname" TYPE="hidden" NAME="keyStoreName" VALUE="%value keyStoreName encode(htmlattr)%"> 
                            </TD>
                        </TR>
                        <TR>
				        	<TD class="evenrow"><label for="desc">Description(optional)</label></TD>
				          	<TD class="evenrow-l"><INPUT id="desc" NAME="keyStoreDescription" VALUE="%value keyStoreDescription encode(htmlattr)%"> </TD>
                        </TR>
                        <TR>
					        <TD class="oddrow"><label for="type">Type</label></TD>
					        <TD class="oddrow-l"><SELECT id="type" NAME="keyStoreType" class="listbox" onchange="changeval()"></SELECT></TD>		
                        </TR>
                        <TR>
					        <TD class="evenrow"><label for="provider">Provider</label></TD>
					       	<TD class="evenrow-l"><SELECT id="provider" class="listbox" NAME="keyStoreProvider"></SELECT></TD>
                        </TR>
                        <TR>
					        <TD class="oddrow"><label for="loc">Location</label></TD>
                            <TD class="oddrow-l">
							<INPUT size="40" id="loc" NAME="keyStoreLocation" VALUE="%value keyStoreLocation encode(htmlattr)%" onChange="confirmLocationChange();">
                            <INPUT TYPE="hidden" NAME="keyStoreLocationChanged" VALUE="false">
                            </TD>
                        </TR>                 
                        <TR>
				           	<TD class="evenrow"><label for="pwd">Password </label></TD>
                            <TD class="evenrow-l">
                                %ifvar nullKSPassword equals('true')%
					           		<INPUT TYPE="password" id="pwd" NAME="keyStorePassword" autocomplete="off" VALUE="" onChange="document.addform.keyStorePasswordChanged.value=true;"/>
                            %else%
					           		<INPUT TYPE="password" id="pwd" NAME="keyStorePassword" autocomplete="off"  VALUE="******" onChange="document.addform.keyStorePasswordChanged.value=true;"/>
                            %endif%
				           		<INPUT id="pwd" TYPE="hidden" NAME="keyStorePasswordChanged" VALUE="false">
                            </TD>
                        </TR>
                        <TR>
				            <TD class="oddrow"><label for="rpwd">Re-type Password</label> </TD>
                         %ifvar nullKSPassword equals('true')%
					            <TD class="oddrow-l"><INPUT id="rpwd" TYPE="password" NAME="retype_keyStorePassword"  autocomplete="off" VALUE=""/></TD>
                         %else%
						    <TD class="oddrow-l"><INPUT id="rpwd" TYPE="password" NAME="retype_keyStorePassword"  autocomplete="off" VALUE="******"/></TD>
                         %endif%
                        </TR>
                        ...
                        <tr>
                            ...
                            <td class="oddrow-l">
                                %ifvar isHsm equals('true')%
									<INPUT TYPE="radio" name="isHsm" id="isHsm1"  VALUE="true" checked><label for="isHsm1">True</label></INPUT>
							        <INPUT TYPE="radio" name="isHsm" id="isHsm2"  VALUE="false"><label for="isHsm2">False</label></INPUT>
                                %else%
									<INPUT TYPE="radio" name="isHsm" id="isHsm1"  VALUE="true" ><label for="isHsm1">True</label></INPUT>
							        <INPUT TYPE="radio" name="isHsm" id="isHsm2"  VALUE="false" checked><label for="isHsm2">False</label></INPUT>
                                %endif%
                            </td>
                        </tr>   
                        %endif%
                ...
                %else% <!-- edit_add/edit_edit start-->
                    ...
                    %scope keyStore%
                    <TR>
			        	<TD class="oddrow"><B><label for="ksname">Alias</label></B></TD>
                        <TD class="oddrow-l">
			        	%value keyStoreName encode(html)%
			          	<INPUT TYPE="hidden" id="ksname" NAME="keyStoreName" VALUE="%value keyStoreName encode(htmlattr)%"> 
                        </TD>
                    </TR>
                    <TR>
			        	<TD class="evenrow"><B><label for="desc">Description(optional)</label></B></TD>
                        <TD class="evenrow-l">
			          	%value keyStoreDescription encode(html)%
			          	<INPUT TYPE="hidden" id="desc" NAME="keyStoreDescription" VALUE="%value keyStoreDescription encode(htmlattr)%"> 
                        </TD>
                    </TR>
                    <TR>
				        <TD class="oddrow"><B><label for="type">Type</label></B></TD>
                        <TD class="oddrow-l">
				        %value keyStoreType encode(html)%
				        <INPUT TYPE="hidden" id="type" NAME="keyStoreType" VALUE="%value keyStoreType encode(htmlattr)%"> 
                        <!-- <SELECT NAME="keyStoreType" class="listbox" onchange="changeval()"></SELECT> -->
                        </TD>       
                    </TR>
                    <TR>
				        <TD class="evenrow"><B><label for="provider">Provider</label></B></TD>
                        <TD class="evenrow-l">
				       	%value keyStoreProvider encode(html)%
				       	<INPUT TYPE="hidden" id="provider" NAME="keyStoreProvider" VALUE="%value keyStoreProvider encode(htmlattr)%"> 
                        <!-- <SELECT class="listbox" NAME="keyStoreProvider"></SELECT> -->
                        </TD>
                    </TR>
                    <TR>
				        <TD class="oddrow"><B><label for="loc">Location</label><B></TD>
                        <TD class="oddrow-l">
				    	%value keyStoreLocation encode(html)%
				    	<INPUT TYPE="hidden" id="loc" NAME="keyStoreLocation" VALUE="%value keyStoreLocation encode(htmlattr)%" onChange="confirmLocationChange();"></TD>
				    	<INPUT TYPE="hidden" NAME="keyStoreLocationChanged" VALUE="%value keyStoreLocationChanged encode(htmlattr)%">
                    </TR>
			    	<INPUT TYPE="hidden" NAME="handle" VALUE="%value handle encode(htmlattr)%">
                    ...
                    %ifvar ../type equals('key')%
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td class="oddrow-l" width="50%">Password</td>
							          				<td class="oddrow-l" width="50%"><label for="rpwd">Re-type Password</label></td>
                        ...
                        %loop configuredKeyAliases%
                              <TR>
							  	<script>writeTD("rowdata-r");</script><label for="%value keyAlias encode(htmlattr)%">%value keyAlias encode(html)%</label>
                                ...
                                <script>writeTD("rowdata");</script>
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <script>writeTD("rowdata");</script><INPUT TYPE="password"  id="rpwd" autocomplete="off" NAME="re_pkPasswords" %ifvar nullPassword equals('false')% value="******" %else% value="" %endif%/> </td>
                        ...
                        %loop nonConfiguredKeyAliases%
                            <TR>
								  	<script>writeTD("rowdata-r");</script><label for="%value encode(htmlattr)%">%value encode(html)%</label>
                                    ...
                                    <script>writeTD("rowdata");</script>
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <script>writeTD("rowdata");</script><INPUT TYPE="password" id="rpwd" NAME="re_pkPasswords" autocomplete="off" VALUE=""/></td>
            ...
            %else% <!-- Add keystore/truststore alias block-->
                <TR>
			        <TD class="oddrow"><label for="ksname">Alias</label></TD>
			        <TD class="oddrow-l"><INPUT id="ksname" NAME="keyStoreName" VALUE="%value keyStoreName encode(htmlattr)%"> </TD>
                </TR>
                <TR>
			       	<TD class="evenrow"><label for="desc">Description(optional)</label></TD>
			       	<TD class="evenrow-l"><INPUT id="desc" NAME="keyStoreDescription" VALUE="%value keyStoreDescription encode(htmlattr)%"> </TD>
                ...
                <TR>
			        <TD class="oddrow"><label for="loc">Location</label></TD>
                    <TD class="oddrow-l">
					<INPUT size="40" id="loc" NAME="keyStoreLocation" VALUE="%value keyStoreLocation encode(htmlattr)%">
                </TD>
                ...
                <TR>
		           	<TD class="evenrow"><label for="pwd">Password </label></TD>
                    <TD class="evenrow-l">
		           		<INPUT id="pwd" TYPE="password" NAME="keyStorePassword" autocomplete="off" VALUE="%value keyStorePassword encode(htmlattr)%" />
			           	<INPUT id="pwd" TYPE="hidden" NAME="keyStorePasswordChanged" VALUE="true">
                    </TD>
                </TR>
            <TR>
		           	<TD class="oddrow"><label for="rpwd">Re-type Password</label></TD>
				<TD class="oddrow-l"><INPUT id="rpwd" TYPE="password" NAME="retype_keyStorePassword"  autocomplete="off" VALUE="%value retype_keyStorePassword encode(htmlattr)%"/></TD>
                </TR>
                %ifvar type equals('key')%
                <tr>
                    <td class="oddrow">HSM Based Keystore</td>
