<HTML>
  ...
  <BODY onLoad="setNavigation('log-error-recent.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Logs_ErrorScrn');">
     ...
     %endif%
          <TABLE width=100%>
            ...
            <TR>
                    ...
                    <TR>
                      <TD class="oddrow" nowrap>
                        <TABLE class="noborders">
                          <TR>
                            <TD>
                              <INPUT TYPE="radio" NAME="order" id="order" VALUE="Ascending" %value ascendchecked encode(htmlattr)%>
                            </TD>
                            <TD>
                              <label for="order">Display Log Entries oldest to newest starting from the beginning</label>
                            </TD>
                          </TR>
                          <TR>
                            <TD>
                              <INPUT TYPE="radio" NAME="order" id="order1" VALUE="Descending" %value descendchecked encode(htmlattr)%>
                            </TD>
                            <TD>
                              <label for="order1">Display Log Entries newest to oldest starting from the end</label>
                            </TD>
                          </TR>
                        </TABLE>
                      </TD>
              ...
              <TABLE class="noborders">
                <TR>
			      <TD><INPUT TYPE="checkbox" NAME="expandstack" id="expandstack" %value expandchecked encode(htmlattr)%></TD>
                  <TD><label for="expandstack">Expand Stack Trace Data</label></TD>
                </TR>
              </TABLE>
                      </TD>
