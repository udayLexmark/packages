          ...
          else if(enabled == "true")
          {
            if(confirm("Port must be disabled so that you can edit these settings.  Would you like to disable the port?"))
            {
				...
				if(is_csrf_guard_enabled && needToInsertToken) {
                   createForm("htmlForm_configSSLSOCK", 'configSSLSOCK.dsp', "POST", "HEAD");
				   setFormProperty("htmlForm_configSSLSOCK", "listenerKey", "%value listenerKey%");
				   setFormProperty("htmlForm_configSSLSOCK", "pkg", "%value pkg%");
				   %ifvar listenerType%
				   setFormProperty("htmlForm_configSSLSOCK", "listenerType", "%value listenerType%");
				   %endif%
				   setFormProperty("htmlForm_configSSLSOCK", "mode", "edit");
				   setFormProperty("htmlForm_configSSLSOCK", "disableport", "true");
				
				   setFormProperty("htmlForm_configSSLSOCK", _csrfTokenNm_, _csrfTokenVal_);
					var htmlForm_configSSLSOCK = document.forms["htmlForm_configSSLSOCK"];
					htmlForm_configSSLSOCK.submit();
				} else {
				...
				if(is_csrf_guard_enabled && needToInsertToken) {
                   createForm("htmlForm_configSSLSOCK2", 'configSSLSOCK.dsp', "POST", "HEAD");
				   setFormProperty("htmlForm_configSSLSOCK2", "listenerKey", "%value listenerKey%");
				   setFormProperty("htmlForm_configSSLSOCK2", "pkg", "%value pkg%");
				   %ifvar listenerType%
				   setFormProperty("htmlForm_configSSLSOCK2", "listenerType", "%value listenerType%");
				   %endif%
				   setFormProperty("htmlForm_configSSLSOCK2", "mode", "edit");
				   
				   setFormProperty("htmlForm_configSSLSOCK2", _csrfTokenNm_, _csrfTokenVal_);
					var htmlForm_configSSLSOCK2 = document.forms["htmlForm_configSSLSOCK2"];
					htmlForm_configSSLSOCK2.submit();
				} else {
