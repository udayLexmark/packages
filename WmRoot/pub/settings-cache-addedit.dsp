  ...
  <head>
    ...
    function validate(theForm)
    {
		...
		if (js_clustered1.checked) 
		{
			var js_maxEntriesInCache = theForm.maxEntriesInCache; 
			if(!isValidInteger(js_maxEntriesInCache, "'Maximum Entries in Cache'", true, true))
			{
				return false;
			}
		}
    ...
    function enableDisableMaximumOffHeapField()
    {
		...
		if(isBigMemoryLicenced == true){
			js_overflowToOffHeap.disabled = false
    ...
    <body onLoad="setNavigation('settings-cache-addedit.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_Cache_Edit');">
    %else%
    <body onLoad="setNavigation('settings-cache-addedit.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_Cache_Add');">
    %endif%
        ...
        <tr>
            <td colspan="2">
                <ul class="listitems">
                    <li class="listitem">
						<script>
						createForm("htmlform_settings_cache_manager_view", "settings-cache-manager-view.dsp", "POST", "BODY");
						setFormProperty("htmlform_settings_cache_manager_view", "managerType", "%value managerType%");
						setFormProperty("htmlform_settings_cache_manager_view", "cacheManagerName", "%value cacheManagerName%");
						</script>
						<script>getURL("settings-cache-manager-view.dsp?managerType=%value managerType encode(url)%&cacheManagerName=%value cacheManagerName encode(url)%","javascript:document.htmlform_settings_cache_manager_view.submit();","Return to&nbsp;%value cacheManagerName encode(html)%")</script></li>
                    %ifvar configMismatch%
                        <li class="listitem">
							<script>
							createForm("htmlform_settings_cache_diff", "settings-cache-diff.dsp", "POST", "BODY");
							setFormProperty("htmlform_settings_cache_diff", "cacheManagerName", "%value cacheManagerName%");
							setFormProperty("htmlform_settings_cache_diff", "cacheName", "%value cacheName%");
							</script>
							<script>getURL("settings-cache-diff.dsp?cacheManagerName=%value cacheManagerName encode(url)%&cacheName=%value cacheName encode(url)%","javascript:document.htmlform_settings_cache_diff.submit();","Synchronize Cache Settings from Terracotta Server Array")</script></li>
                    %endif%
                </ul>
            </td>
        </tr>
                    ...
                    <tr>
                        <td valign="top" width="50%">
                            <table class="tableView" width="99%">
                                ...
                                <tr>
                                    <td class="oddrow" width="50%" ><label for="cacheName">Cache Name</label></td>
                                ...
                                <tr>
                                    <td class="evenrow"><label for="maxElementsInMemory">Maximum Elements in Memory</label></td> 
                                    <td class="evenrow-l">
                                        %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="oddrow"><label for="eternal">Eternal</label></td> 
                                    <td class="oddrow-l">
                                ...
                                <tr>
                                    <td class="evenrow"><label for="timeToLiveSeconds">Time to Live</label></td>   
                                    <td class="evenrow-l">
                                        %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="oddrow" width="50%"><label for="timeToIdleSeconds">Time to Idle</label></td>    
                                    <td class="oddrow-l" width="50%">
                                        %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="evenrow"><label for="overflowToDisk">Overflow to Disk</label></td>   
                                    <td class="evenrow-l">
                                    %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="oddrow"><label for="diskPersistent">Persist to Disk</label></td> 
                                    <td class="oddrow-l">
                                    %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="evenrow"><label for="maxEntriesLocalDisk">Maximum Entries Local Disk</label></td> 
                                    <td class="evenrow-l">
                                        %ifvar operation equals('add')%
                            ...
                            <table class="tableView" width="99%">
                                ...
                                <tr>
                                    <td class="oddrow" width="50%"><label for="diskExpiryThreadIntervalSeconds" > Disk Expiry Thread Interval</label></td> 
                                    <td class="oddrow-l" width="50%">
                                        %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="evenrow"><label for="diskSpoolBufferSizeMB" > Disk Spool Buffer Size</label></td> 
                                    <td class="evenrow-l">
                                        %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="oddrow"><label for="clearOnFlush" > Clear on Flush</label></td>  
                                    <td class="oddrow-l">
                                    %ifvar operation equals('add')% 
                                ...
                                <tr>
                                    <td class="evenrow"><label for="copyOnRead" > Copy on Read</label></td>   
                                    <td class="evenrow-l">
                                    %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="oddrow"><label for="copyOnWrite" > Copy on Write</label></td>   
                                    <td class="oddrow-l">
                                    %ifvar operation equals('add')% 
                                ...
                                <tr>
                                    <td class="evenrow"><label for="memoryStoreEvictionPolicy" > Memory Store Eviction Policy</label></td>   
                                    <td class="evenrow-l">
                                        %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="oddrow"><label for="logging" > Logging</label></td> 
                                    <td class="oddrow-l">
                                    %ifvar operation equals('add')% 
                            ...
                            <table class="tableView" width="99%">
                              ...
                              <script>populateInitialValues();</script>
                                ...
                                <tr>
                                    <td class="evenrow" width="50%"><label for="overflowToOffHeap" > Overflow to Off-heap</label></td>   
                                ...
                                <tr>
                                    <td class="oddrow"><label for="maxMemoryOffHeap" > Maximum Off-heap</label></td>    
                                    <td class="oddrow-l">
                                        %ifvar operation equals('add')%
                        ...
                        <td valign="top">
                            <table class="tableView" width="100%" >
                                ...
                                <tr>
                                    <td width="50%" class="oddrow"><label for="clustered"> Distributed</label></td> 
                                ...
                                <tr>
                                    <td  width="50%" class="evenrow"><label for="consistency"> Consistency</label></td>   
                                ...
                                <tr>
                                    <td width="50%" class="oddrow"><label for="maxEntriesInCache"> Maximum Entries in Cache</label></td>   
                                    <td width="50%" class="oddrow-l">
                                        %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="evenrow" width="50%"><label for="enabled"> Enable High Availability</label></td>
                                    <td class="evenrow-l">
                                    %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="oddrow"><label for="timeoutMillis"> Timeout</label></td> 
                                    <td class="oddrow-l">
                                        %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="evenrow" width="50%"><label for="timeoutBehaviorType"> Timeout Behavior</label></td>   
                                    <td class="evenrow-l" width="50%">
                                        %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="oddrow"><label for="immediateTimeout"> Immediate Timeout When Disconnected</label></td> 
                                    <td class="oddrow-l">
                                    %ifvar operation equals('add')%
                                ...
                                <tr>
                                    <td class="evenrow"><label for="synchronousWrites"> Synchronous Writes</label></td> 
                                    <td class="evenrow-l">
                                    %ifvar operation equals('add')%
