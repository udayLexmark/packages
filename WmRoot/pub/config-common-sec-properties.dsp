		    ...
		    <td class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
				%ifvar useJSSE -notempty%
					%ifvar useJSSE equals('true')%
						<input type="radio" id="useJSSE1" name="useJSSE" value="yes" checked><label for="useJSSE1">Yes</label></input>
						<input type="radio" id="useJSSE2" name="useJSSE" value="no"><label for="useJSSE2">No</label></input>
					%else%
						<input type="radio" id="useJSSE1" name="useJSSE" value="yes"><label for="useJSSE1">Yes</label></input>
						<input type="radio" id="useJSSE2" name="useJSSE" value="no" checked><label for="useJSSE2">No</label></input>
					%endif%
				%else%
