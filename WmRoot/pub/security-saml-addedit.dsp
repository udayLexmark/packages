...
<META HTTP-EQUIV="Expires" CONTENT="-1">
  ...
  <BODY onLoad="loadKeyStoresOptions(); setNavigation('security-saml.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_EditSAMLIssuer');">
  %else%
  <BODY onLoad="loadKeyStoresOptions(); setNavigation('security-saml.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_AddSAMLTokenIssuerScrn');">
  %endif%
    <TABLE width="100%">
      ...
      <TR>
        <TD colspan="2">
          <ul class="listitems">
		    <script>
			createForm("htmlform_security_saml", "security-saml.dsp", "POST", "BODY");
			</script>
            <li>
			<script>getURL("security-saml.dsp","javascript:document.htmlform_security_saml.submit();","Return to Trusted SAML Token Issuers");</script></li>
          </UL>
        </TD>
      </TR>
      <TR>
      ...
      <TABLE class="tableView">
        ...
        function checkDuplicate()
        {
          ...
          <TR>
            <TD class="oddrow"><label for="IssuerName">Issuer Name</label></TD>
            <TD class="oddrow-l">
              <INPUT NAME="IssuerName" id="IssuerName" VALUE="%value IssuerName encode(htmlattr)%"> </TD>
          </TR>
          <TR>
            <TD class="evenrow"><label for="TruststoreAlias">Truststore Alias</label></TD>
            <TD class="evenrow-l">
              <SELECT class="listbox" name="TruststoreAlias" id="TruststoreAlias" onchange="changeval()"></SELECT>
          </TR>
          <TR>
            <TD class="oddrow"><label for="CertAlias">Certificate Alias</label></TD>
            <TD class="oddrow-l">
              <!--<INPUT NAME="CertAlias" VALUE="%value CertAlias encode(htmlattr)%"> </TD> -->
              <select class="listbox" name="CertAlias" id="CertAlias"></select>
          </TR>
          <TR>
            <TD class="evenrow"><label for="ClockSkew">Clock Skew</label></TD>
            <TD class="evenrow-l">
              <INPUT NAME="ClockSkew" id="ClockSkew" VALUE="%value ClockSkew encode(htmlattr)%"> </TD>
          </TR>
