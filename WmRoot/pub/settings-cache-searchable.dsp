          ...
          <tr>
            ...
            <tr>
                 <td class="oddrow" width="50%">
                       <label for="searchableCheck">Searchable </label>
                 </td>
                 <td class="oddrow-l">
            ...
            <tr>
                 <td class="evenrow" scope="row" width="50%">
                      ...
                      <table class="tableView">
                          <tbody>
                             <tr>
                                  ...
                                  <td>
                                       <label for="searchableKeyCheck"> Key</label>
                                  </td>
                                  <td>
                                  ...
                                  <td>
                                       <label for="searchableValueCheck"> Value</label>
                                  </td>
                             </tr>
                         </tbody>
                      </table>
                                ...
                                <tr>
                                  ...
                                  <td style="background-color: #ddd; padding: 0px; margin: 0px">
                                        <table width="100%" style="border-spacing:0;">
                                            ...
                                            <tr>
                                                <td colspan="2" align="center" class="subheading" style="border-bottom:solid #ccc 2px;" scope="col">
                                                  Extract By
                                                </td>
                                            </tr>
                                            <tr>
                                              <td width="50%" class="subheading" style="border-right:solid white 2px;padding-left:4px;" scope="col">
                                                   Class/Expression
                                              </td>
                                              <td class="subheading" style="padding-left:4px;" scope="col">
                                                   Properties
                                              </td>
                                            </tr>
              ...
              %ifvar operation equals('add')%   
                  <tr id="0">
                    <td class="evenrow" style="text-align:center;"> 
                        <input type="text" id="attribute" title="Attribute name" name="attribute_text" disabled/>
                    </td>
                    <td class="evenrow" style="white-space:nowrap;"> 
                      <input type="radio" id="expression_radio_1" title="Expression as Extract Method" name="class1" value="expression" onclick="disableProperties('expression_radio_1','properties_1')" checked disabled/>
					  <label for="expression_radio_1">Expression</label>
					  <input type="radio" name="class1" value="class" title="Class as Extract Method" id="class_radio_1" onclick="enableProperties('class_radio_1','properties_1')" disabled/>
					  <label for="class_radio_1">Class</label>
                    </td>
                    <td class="evenrow" style="padding-left:2px;">
                       <table class="expressionTable">
                         <tr>
                           <td width="50%" class="expressionCell"> 
                               <input type="text" name="class_expression" title="Extract by class/Expression" disabled/>
                           </td>
                           <td align="right">    
                               <input type="text" name="properties" id="properties_1" title="Property" disabled/>
                           </td>
                        </tr>
                      </table>                                                    
                    </td>
                    <td class="evenrow" style="text-align:center;"> 
                      <input class="addButton" type="button" title="Add Searchable Attribute" onclick="addParamRow()" disabled></input>
                      <input id="deleteElementtoReferenceParamsrow0" title="Delete Searchable Attribute" class="deleteDisableButton" type="button" name="deleteElementtoReferenceParamsrow0" onclick="" ></input>
                    </td>
                  </tr>
                 %else%
                 ...
                 %else%
                  <!-- [start] adding an empty row if no search attributes added.  -->
                    <tr id="0">
                    <td class="evenrow" style="text-align:center;"> 
                        <input type="text" name="attribute_text" title="Attribute name" />
                    </td>
                    <td class="evenrow" style="white-space:nowrap;"> 
                      <input type="radio" id="expression_radio_1" title="Expression as Extract Method" name="class1" value="expression" onclick="disableProperties('expression_radio_1','properties_1')" checked/>
					  <label for="expression_radio_1">Expression</label>
					  <input type="radio" name="class1" value="class" id="class_radio_1" title="Class as Extract Method" onclick="enableProperties('class_radio_1','properties_1')" disabled/>
					  <label for="class_radio_1">Class</label>
                    </td>
                    <td class="evenrow" style="padding-left:2px;">
                       <table class="expressionTable">
                         <tr>
                           <td width="50%" class="expressionCell"> 
                               <input type="text" name="class_expression" title="Extract by class/Expression"/>
                           </td>
                           <td align="right">    
                               <input type="text" name="properties" id="properties_1" title="Property" disabled/>
                           </td>
                    ...
                    <td class="evenrow" style="text-align:center;"> 
                      <input class="addButton" type="button" title="Add Searchable Attribute" onclick="addParamRow()"></input>
                      <input id="deleteElementtoReferenceParamsrow0" title="Delete Searchable Attribute" class="deleteDisableButton" type="button" name="deleteElementtoReferenceParamsrow0" onclick="" disabled></input>
                    </td>
                  </tr> 
