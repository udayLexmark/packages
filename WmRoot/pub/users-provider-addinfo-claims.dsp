            ...
            <tr>
                    ...
                    <form id="adduserinfoclaim" name="adduserinfoclaim" method="POST" action="users-provider-addremove-claims.dsp">
                         ...
                         <table class="tableView" width="75%">
                            ...
                            <tr>
                              <td nowrap valign="top" class="oddrow" width="25%"><label for="infoclaimname">Claim Name</label></td>
                                %ifvar action equals('edituserinfoclaim')%
                                    <td class="oddrow-1">%value infoclaimname encode(html)%
                                %else%
                                    <td class="oddrow-1">
                              ...
                              <tr>
                              <td class="oddrow"><label for="infoclaimvalues">Enter Claim values separated by commas</label></td>
                                %ifvar action equals('edituserinfoclaim')%
                                    <td class="oddrow-1"><textarea style="width:100%;" wrap="off" rows="5" name="infoclaimvalues" id="infoclaimvalues" cols="20">%value infoclaimvalues encode(html)%</textarea></td>
                                %else%
