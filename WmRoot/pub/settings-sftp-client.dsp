        ...
        <tr>
            <td colspan="2">
                <ul class="listitems">
                    ...
                    <li class="listitem">
					<script>getURL("settings-sftp-client-serveralias-addedit.dsp?operation=add", "javascript:document.htmlform_settings_sftp_client_serveralias_addedit.submit();", "Create&nbsp;Server&nbsp;Alias");</script>
