                ...
                <TD valign=top  colspan="2" class="oddrow-l">
                  <TABLE cellspacing="1" cellpadding="0">
                    ...
                    <tr><td><img src="images/blank.gif" width="10"></td><td>
                      <INPUT type="radio" name="filter" id="filter1"  value="includeall" checked></td><td><label for="filter1">Include all files</label>.
                    </td></tr>
                    <tr><td><img src="images/blank.gif" width="10"></td><td>
                        <INPUT type="radio" name="filter" id="filter2"  value="include"></td><td><label for="filter2">Include only selected files</label>.
                    </td></tr>
                    <tr><td><img src="images/blank.gif" width="10"></td><td>
                        <INPUT type="radio" name="filter" id="filter3"  value="exclude"></td><td><label for="filter3">Include all <i>except</i> selected files.</label>
                    </td></tr>
                    <tr><td><img src="images/blank.gif" width="10"></td><td valign=top>
                        <INPUT type="radio" name="filter" id="filter4"  value="include"></td><td><label for="filter4">Include only files specified by filter</label>:<br>
                        <INPUT name="includepattern">
                    </td></tr>
                    <tr><td><img src="images/blank.gif" width="10"></td><td valign=top>
                        <INPUT type="radio" name="filter" id="filter5"  value="exclude"></td><td><label for="filter5">Include all <i>except</i> files specified by filter:</label><br>
          ...
          <tr><td></td><td></td><td>Example filter: *.java, *.class</td></tr>
              ...
              <TR>
                ...
                <TD class="evenrowdata-l" colspan="2" nowrap>
                  <INPUT type="radio" name="type" id="type1"  value="full" checked>Full <font style="font-weight: normal;"><label for="type1">I(Including all files is recommened)</label></font><br>
                  <INPUT type="radio" name="type" id="type2"  value="partial">Patch <font style="font-weight: normal;"><label for="type2">I(For distributing upgrades)</label></font>
                  </TD>
              </TR>
              <TR>
