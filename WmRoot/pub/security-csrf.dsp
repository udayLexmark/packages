...
<head>
  ...
  <body onLoad="setNavigation('security-csrf.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_CSRFGuardScrn');">
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="2">
                <ul class="listitems">
					<script>
					createForm("htmlform_security_csrf_edit", "security-csrf-edit.dsp", "POST", "BODY");
					</script>
                    <li class="listitem">
					<script>getURL("security-csrf-edit.dsp","javascript:document.htmlform_security_csrf_edit.submit();","Edit&nbsp;CSRF&nbsp;Guard&nbsp;Settings");</script></li>
                </ul>
            </td>
        </tr>
