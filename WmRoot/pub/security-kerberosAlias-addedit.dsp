...
<META HTTP-EQUIV="Expires" CONTENT="-1">
  ...
  <BODY setNavigation('security-kerberos.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_EditKerberosAlias');">
  %else%
  <BODY setNavigation('security-kerberos.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_AddKerberosAliasScrn');">
  %endif%
    <TABLE width="100%">
      <TR>
