...
<head>
  ...
  <body onLoad="setNavigation('settings-cache.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_CachingScrn');">
    <table width="100%">
        ...
        <tr>
            <td colspan="2">
                <ul class="listitems">       
					<script>
						createForm("htmlform_settings_cache_manager_addedit", "settings-cache-manager-addedit.dsp", "POST", "BODY");
						setFormProperty("htmlform_settings_cache_manager_addedit", "operation", "add");
						</script>
                    <li class="listitem">
					<script>getURL("settings-cache-manager-addedit.dsp?operation=add","javascript:document.htmlform_settings_cache_manager_addedit.submit();","Add Cache Manager")</script></li>
                </ul>
