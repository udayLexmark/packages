...
<head>
  ...
  <body onLoad="setNavigation('security-oauth-tokens.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Security_OAuthTokens');">
    ...
    <table width="100%">
      ...
      <TR> 
        ...
        <TR> 
		  <TH scope="col" CLASS="oddcol-l" nowrap>Client Application</TH>
		  <TH scope="col" CLASS="oddcol" nowrap>Owner ID</TH>
		  <TH scope="col" CLASS="oddcol" nowrap>Access Token</TH>
		  <TH scope="col" CLASS="oddcol" nowrap>Expiry Time</TH>
		  <TH scope="col" CLASS="oddcol" nowrap>Refresh Token</TH>
		  <TH scope="col" CLASS="oddcol" nowrap>Remaining Refresh Count</TH>
		  <TH scope="col" CLASS="oddcol" nowrap>Delete</TH>
        </TR>
              ...
              <TR>
                  ...
                  <SCRIPT>writeTDspan("rowdata","1");</SCRIPT>
					<A href="javascript:document.forms['tokens'].submit()" onClick="return removeToken('%value token_id encode(javascript)%', '%value access_token_id encode(javascript)%', '%value refresh_token_id encode(javascript)%');">
                      <IMG src="icons/delete.png" alt="Token" border="none">
                    </A>
                  </TD>     
