...
<head>
  ...
  %endif%
  %ifvar operation equals('edit')%
    <body onLoad="setNavigation('settings-cache-manager-addedit.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_CacheManager_Edit');">
  %else%
    <body onLoad="setNavigation('settings-cache-manager-addedit.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_CacheManager_Add');">
  %endif%
    <table width="100%">
        %ifvar hideBreadcrumbs%%else%
          <tr>
            <td class="breadcrumb" colspan="2"> 
              Settings &gt;
              Caching &gt;
              %ifvar operation equals('edit')%%value cacheManagerName encode(html)%&nbsp;&gt;&nbsp;Edit%else%Add Cache Manager%endif%
            </td>
          </tr>
        %endif%
        ...
        <tr>
            ...
            <input type="hidden" name="operation">
                        <table class="tableView width50">
                            ...
                            <tr>
                                <td class="oddrow" ><label for="cacheManagerName">Name</label></td>
                                <td class="oddrow-l" >
                            ...
                            <tr>
                                <td class="evenrow"><label for="tsaURL">Terracotta Server Array URLs</label></td>     
                                <td class="evenrow-l">
                                    %ifvar operation equals('add')%
				...
				<br/>Use commas (,) to separate entries.
                                %endif% 
                                    %ifvar operation equals('edit')%
                            ...
                            <tr>
                                <td class="oddrow"><label for="rejoin">Rejoin</label></td>  
                                <td class="oddrow-l">
