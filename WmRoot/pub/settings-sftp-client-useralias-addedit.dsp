...
<head>
  ...
  %ifvar operation equals('edit')%
    <body onLoad="setNavigation('settings-sftp-client-useralias-addedit.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_SFTP_UserAliasSettings_Edit');">
  %else%
    <body onLoad="setNavigation('settings-sftp-client-useralias-addedit.dsp', 'doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_SFTP_UserAliasSettings_Create');">
  %endif%
    <table width="100%">
        ...
        <tr>
            <td colspan="2">
                <ul class="listitems">
                    ...
                    <li class="listitem"><script>getURL("settings-sftp-client.dsp", "javascript:document.htmlform_settings_sftp_client.submit();", "Return to SFTP");</script>
					</li>
                    <li class="listitem"><script>getURL("settings-sftp-client-usersettings.dsp", "javascript:document.htmlform_settings_sftp_client_usersettings.submit();", "Return to User Alias Settings");</script>
                ...
                <tr>
                    <td>
                        ...
                        <table class="tableView" width="100%">
                            ...
                            <tr>
                                <td class="evenrow" width="30%"><label for="userName">User Name</label></td>
                            ...
                            <tr>
                                ...
                                <td class="oddrow-l" width="70%">
                                    ...
                                    <input type="radio" name="authenticationType" id="authenticationType1" value="password" checked onclick="changeColumnProperties();"/><label for="authenticationType1"> Password&nbsp;&nbsp;</label>
                                    <input type="radio" name="authenticationType" id="authenticationType2" value="publicKey" %ifvar authenticationType equals('publicKey')% checked %endif%  onclick="changeColumnProperties();"/><label for="authenticationType2"> Public Key </label>
                                </td>
                            </tr>
                            </table>
                            <div name="passwordDiv" id="passwordDiv" style="display:block;">
                                <table class="tableView" width="100%" >
                                    <tr>
                                        <td class="evenrow" width="30%"><label for="password">Password</label></td>
                                        <td class="evenrow-l" width="70%">
                                            <input type="password" name="password" id="password" autocomplete="off" style="width:100%;"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="oddrow"width="30%"><label for="rePassword">Re-type Password</label></td>
                                        <td class="oddrow-l" width="70%" >
                            ...
                            <div name="passPhraseDiv" id="passPhraseDiv" style="display:block;">
                                <table class="tableView" width="100%" >
                                    <tr>
                                        <td class="evenrow" width="30%"><label for="privateKeyFileLocation">Private Key Location</label></td>    
                                        <td class="evenrow-l" width="70%">
                                            %ifvar operation equals('add')%
                                    ...
                                    <tr>
                                        <td class="oddrow" width="30%"><label for="passPhrase">PassPhrase</label></td>
                                        <td class="oddrow-l" width="70%">
                                            <input type="password" name="passPhrase" id="passPhrase" autocomplete="off" style="width:100%;"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="evenrow" width="30%"><label for="rePassPhrase">Re-type PassPhrase</label></td>
                                        <td class="evenrow-l" width="70%">
                            ...
                            <div name="othrePropsDiv" id="othrePropsDiv" style="display:block;">
                                ...
                                <table class="tableView" width="100%" >
                                    <tbody id="othreSubtype">
                                        <tr>
                                            <td class="evenrow" width="30%"><label for="sftpServerAlias">SFTP Server Alias</label></td>
                                            <td class="evenrow-l" width="70%">
                                                %ifvar operation equals('add')%
							...
							<tbody>
								...
								<tr>
									<td class="evenrow" width="30%"><label for="maximumRetries">Maximum Retries</label></td>    
									<td class="evenrow-l" width="70%">
										%ifvar operation equals('add')%
								...
								<tr>
									<td class="oddrow" width="30%"><label for="connectionTimeout">Connection Timeout</label></td>    
									<td class="oddrow-l" width="70%">
										%ifvar operation equals('add')%
								...
								<tr>
									<td class="evenrow" width="30%"><label for="sessionTimeout">Session Timeout</label></td>    
									<td class="evenrow-l" width="70%">
										%ifvar operation equals('add')%
								...
								<tr>
									<td class="oddrow" width="30%">Strict Host Key Checking</td>	
									<td class="oddrow-l" width="70%">
										<input type="radio" name="strictHostKeyChecking" id="strictHostKeyChecking1" value="yes" checked><label for="strictHostKeyChecking1"> Yes </label>
								    	 &nbsp;<input type="radio" name="strictHostKeyChecking" id="strictHostKeyChecking2" value="no" %ifvar strictHostKeyChecking equals('no')%checked%endif%><label for="strictHostKeyChecking2"> No </label>
									</td>
								</tr>
								<tr>
									<td class="evenrow" width="30%"><label for="compression">Compression</label></td>	
									<td class="evenrow-l" width="70%">
								...
								<tr>
									<td class="oddrow" width="30%"><label for="compressionLevel">Compression Level</label></td>	
									<td class="oddrow-l" width="70%">
										%ifvar operation equals('add')%
