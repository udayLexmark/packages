            ...
            <TR>
                <TD>
                    <UL class="listitems">
						...
						<script>getURL("integration-live-metadata-share.dsp","javascript:document.htmlform_integration_live_metadata_share.submit();","Return to webMethods Cloud Applications");</script>
						</LI>
                    </UL>
                </TD>
            </TR>
