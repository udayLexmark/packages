          ...
          %endif%
            ...
            <TR>
                <TD colspan="3">
                    <UL class="listitems">
                        <LI>
						<script>
					    createForm("htmlform_integration_live_metadata_share", "integration-live-metadata-share.dsp", "POST", "BODY");
					    </script>
						<script>getURL("integration-live-metadata-share.dsp","javascript:document.htmlform_integration_live_metadata_share.submit();","Return to webMethods Cloud Applications");</script></LI>
                    </UL>
                </TD>
            </TR>
            <TR>
            <TD width="70%">
              ...
              <TABLE WIDTH="100%" class="tableView">
                ...
                <TR>
            			<TD class="oddrow" nowrap><label for="applicationName">Name</label></TD>
                  <TD class="oddrow-l">
